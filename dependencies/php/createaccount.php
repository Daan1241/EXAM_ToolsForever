...
require "pdo.php";
if ($sanitized['username'] == "" || $sanitized['username'] == null || $sanitized['password'] == "" || $sanitized['password'] == null || $sanitized['email'] == "" || $sanitized['email'] == null) {
    ...
    if ($result == null) {
        ...
        $password_encrypted = sha1($sanitized['password'] . $salt); // Encrypt password with salt
        ...
        try {
            ...
            $mail->setFrom('info@ElysiumManagementSystems.com', 'Elysium Account Management (NOREPLY)');
            ...
            $mail->Subject = 'Complete your registration at Elysium Management Systems';
            $mail->Body = '<h2>Welcome to <b>Elysium Management Systems</b>!</h2><br><br>To start setting up your account, you first need to activate it. In order to do so, please click the following link:<br><br><a href="http://localhost/School/examen/beroepsexamen/breoepsexamen_project/dependencies/php/activateaccount.php?token=' . $activationkey . '">Activate my account</a><br><br>Did you not create an account? In that case, feel free to ignore and delete this E-mail.';
            $mail->AltBody = 'Please use a more modern browser to view this E-mail. To activate your account anyway, use the following link: http://localhost/School/examen/beroepsexamen/breoepsexamen_project/dependencies/php/activateaccount.php?token='.$activationkey;
