...
CREATE TABLE IF NOT EXISTS `toolsforever`.`locations_has_products` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_locations_has_products_locations_idx` (`locations_locationname` ASC) VISIBLE,
  INDEX `fk_locations_has_products_products1_idx1` (`products_productname` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_locations_has_products_products1`
    ...
    REFERENCES `toolsforever`.`products` (`productname`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 9
